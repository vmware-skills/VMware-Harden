...
> **Companion skills**: [vmware-aiops](https://github.com/zw008/VMware-AIops) (inventory + collectors data source), [vmware-monitor](https://github.com/zw008/VMware-Monitor) (read-only inspection), [vmware-nsx-security](https://github.com/zw008/VMware-NSX-Security) (DFW evidence), [vmware-pilot](https://github.com/zw008/VMware-Pilot) (remediation execution with approval gates), [vmware-policy](https://github.com/zw008/VMware-Policy) (audit log).
